...
.index-news__item{display:flex;align-items:center;gap:28px;padding:20px 30px;background:#fff;border:1px solid #eee;border-radius:6px;box-shadow:0 6px 20px rgba(22,32,46,.06);text-decoration:none;transition:transform .2s ease,box-shadow .2s ease}
