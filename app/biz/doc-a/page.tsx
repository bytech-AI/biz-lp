    ...
    <>
      ...
      <main className="doc-main">
        <div className="doc-content">
          ...
          <h1 className="doc-content__title">【サービス紹介】「実務伴走型法人AI研修｜バイテック法人AI研修」【資料ダウンロード】</h1>
          <img src="/biz/assets/img/wp/Certificate-MockUp-02-2-1024x683.webp" alt="バイテック法人AI研修資料サムネ" className="doc-content__image" />
          <p className="doc-content__desc">実務伴走型法人AI研修サービスバイテック法人AI研修を紹介する「サービス概要資料」となります！</p>
