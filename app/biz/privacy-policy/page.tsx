  ...
  return (
    <>
      ...
      <nav className="pg-breadcrumb">
        <a href="/">TOP</a> <span>&rsaquo; プライバシーポリシー</span>
      </nav>
      ...
      <main className="pg-card">
        ...
        <p className="lead">このプライバシーポリシーは、株式会社AI棒（以下、「乙」とする。）が運営するバイテック法人AI研修（以下、「本サービス」とする。）をご利用の皆様（以下、「利用者」とする。）から取得される個人情報について、その取扱方針を定めるものです。</p>

        <h2>個人情報の利用目的</h2>
        <p>バイテック法人AI研修は、本サービスを通じて利用者から取得した個人情報を次の目的に利用します。</p>
        <ol>
          ...
          <li>（6）イベント、キャンペーンなどのご連絡、バイテック法人AI研修または第三者の広告情報の配信、利用者の興味・関心にあわせたおすすめコンテンツの表示、接続頻度の把握その他会員のサービス利用に対する統計作成及び分析等</li>
        </ol>

        <h2>個人情報の取得</h2>
        <p>バイテック法人AI研修は、本サービスの提供にあたって必要となる範囲で、主に次のような項目の利用者に関する情報を取得します。なお、以下に掲げる情報の項目は例示であり、必要に応じて他の情報を取得する場合もあります。</p>
        ...
        <h2>個人情報の開示</h2>
        <p>バイテック法人AI研修は、利用者の事前の同意がない限り、個人情報を第三者に提供いたしません。ただし、法令、裁判所の判決・決定・命令、官公庁等により開示を要求された場合、必要最小限度の範囲で第三者に対して個人情報を提供する場合があります。</p>
        <p>バイテック法人AI研修は、利用者に対するサービスの提供に必要な範囲で、本サービス上でクラスを提供する講師に対し、バイテック法人AI研修が取得した個人情報を提供できます。講師は、利用者へのサービスの提供のために個人情報を利用する場合があります。</p>

        <h2>個人情報の取扱いの委託</h2>
        <p>バイテック法人AI研修は、上記の「個人情報の利用目的」に記載された利用目的の達成に必要な範囲内で、個人情報の取扱いを第三者（本国外にある者を含みます。）に委託することがあります。個人情報の取扱いを委託する場合、バイテック法人AI研修は、委託先に対して適切な監督を行います。</p>

        <h2>個人情報の開示等</h2>
        <p>利用者は、個人情報の、（1）利用目的の通知、（2）開示、（3）訂正・追加・削除、（4）利用停止、消去及び（5）第三者への提供停止（以下、「開示等」といいます。）の手続を行うことができます。ただし、バイテック法人AI研修が個人情報保護法に基づき開示等の義務を負わない場合、開示等のご請求に対応できない場合があります。開示等のご請求は下記「お問い合わせ窓口」までご連絡ください。</p>
        ...
        <div className="contact-info">
          ...
          株式会社AI棒<br />
          担当部署：バイテック法人AI研修事業部<br />
          電子メール：support@bytech.jp
        </div>

        <h2>セキュリティについて</h2>
        <p>バイテック法人AI研修は、本サービスにおけるセキュリティ確保のため、クレジットカード番号などの重要な情報の入力時には、これらの情報が傍受、妨害または改ざんされることを防ぐ目的でSSL（Secure Sockets Layer）技術を使用しています。</p>

        <h2>その他</h2>
        <p>バイテック法人AI研修は、プライバシーポリシーの全部または一部を変更する場合があります。重要な変更がある場合には、本サービスが提供されるウェブサイトにおいて、分かりやすい方法でお知らせします。</p>
      </main>
