  ...
  return (
    <>
      ...
      <main className="pg-card">
        <h2>第1条（適用範囲）</h2>
        <div className="terms-body">本規約は、株式会社AI棒（以下「乙」という）が提供するサービス「バイテックBiz」の生成AI研修コンテンツの利用（以下「本サービス」といいます）について適用する。本サービスの利用を希望する企業・法人団体・個人（企業・法人団体に所属する役職員を含み、以下総称して「甲」といいます）は、本規約をよく読み、理解し、同意した上で申込み、利用するものとします。乙は、甲が本サービスを利用したときは、本規約に同意しているものとみなす。</div>
